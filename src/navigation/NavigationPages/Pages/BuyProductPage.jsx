...
function BuyProductPage () {
    ...
    return(
        <div className="buy-product-wrapper__outer">
            <div className="buy-product-wrapper__inner three-column-layout">
                <div className="product-image-wrapper">
                    <div className="product-thumbnails-wrapper">
                        ...
                        <div className="product-image__inner">
                            <img
                                src={selectedImgPath ? selectedImgPath : selectedProduct.thumbnail}
                    ...
                    <div className="product-description-wrapper">
                        ...
                        <div className="product-price-wrapper">&#8377; {convertPriceToRupees(selectedProduct.price)}</div>
