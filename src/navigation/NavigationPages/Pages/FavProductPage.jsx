    ...
    return(
        <>
            <div className="cart-label-wrapper">
                ...
                <h5 className="explore-products-now-label">{likedProducts.length ?
                    `You have ${likedProducts.length} items in wishlist` 
                 : 
                    'Your wishlist is empty. Explore products now!'}
                    </h5>                    
            </div>
               ...
               ( <div className="liked-products-wrapper">
                ...
                {likedProducts.map((product, index) => (
                    ...
                    <div className="product-info">
                        ...
                        <button className="buy-now-btn" onClick={()=>navigateToBuyNowPage(product)}>Buy Now</button>
                    </div>
                    </div>
                ))}
                </div>)
            :
            (<div className="fav-product-explore-more-btn">
