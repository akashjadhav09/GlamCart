                    ...
                    <div className="our-story-section">
                        <div className="out-story-desc">
                            <div className="desc-wrapper-inner">
                                <div className="heading text-center my-4"><span>Our Story</span></div>
                                <p className="desc m-2">We believe shopping should be a delightful experience. That's why we created Glam cart a curated destination for fashion and care. Driven by a passion for  quality, sustainability, unique finds, we're committed to bringing you products you'll love, and service you can trust.</p>
                            </div>
